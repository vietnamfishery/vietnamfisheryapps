...
@Component({
  selector: 'app-pond-prepare-detail',
  templateUrl: './pond-prepare-detail.component.html',
  styleUrls: ['./pond-prepare-detail.component.scss']
})
export class PondPrepareDetailComponent implements OnInit {
  invoiceItems: any = [
    {
      no: 1,
      pondName: 'Ao số 1',
